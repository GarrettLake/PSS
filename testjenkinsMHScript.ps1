#Script pulled from https://hodgkins.io/ uploaded to test with jenkins
$service = "$env:Service"
$ScriptBlockContent = { 
    param($Service = $env:Service)
...
Invoke-Command -ComputerName $env:Computer -Credential $cred -ScriptBlock $ScriptBlockContent -ArgumentList $service
